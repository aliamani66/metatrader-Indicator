    ...
    for sym, data in symbols_data.items():
        ...
        for p in presets:
            ...
            ini_lines = [
                ...
                "Visual=1",
                "[TesterInputs]",
                f"InpScenarioName={raw_title}||0||0||0||N",
                "InpOnlyTradeKings=true||false||0||true||N",
                f"InpDisabledKingsList={disabled_str}||0||0||0||N",
                ...
                f"InpAllowedTradingHours={hours_str}||0||0||0||N",
                f"InpMinTradePotential={float(p.get('min_pot', 0.0)):.2f}||0.0||0.5||10.0||N",
                f"InpConsecLossTrigger={trig_int}||0||1||10||N",
                f"InpConsecLossAction={action_int}||1||1||3||N",
