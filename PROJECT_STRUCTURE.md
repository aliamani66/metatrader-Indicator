...
│   │   └── tabs/
│   │       ├── tab_equity.js                # چارت رشد اکوئیتی، افت سرمایه و فیلترهای ۱ تا ۵
...
│   │       └── tab_tester_compare.js        # مقایسه نتایج داشبورد با استراتژی تستر
│   ├── data/
...
│   └── tools/
│       └── bundler.py                       # اسکریپت باندل‌ساز این‌لاین CSS و JS
│
